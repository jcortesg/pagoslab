...
RSpec.describe AccountsController, type: :controller do
  ...
  let(:valid_attributes) {
    ...
    { name: 'My App', description: 'My App Description', phone: '5555555555', website: 'http://www.app.com' }
  }

  let(:invalid_attributes) {
    { name: nil, description: nil, phone: nil, website: nil }
  }
  ...
  describe "PUT #update" do
    context "with valid params" do
      let(:new_attributes) {
        {name: 'My App 2', description: 'My App Description 2', phone: '5555555555', website: 'http://www.myapp2.com'}
      }
